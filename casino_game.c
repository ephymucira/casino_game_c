...
int round1(){
    ...
    int deposit1 ;
    printf("Enter the amount to deposit for the game: ");
    scanf("%d", &deposit1);
    ...
    printf("Correct number is %d",computer1);
    scanf("%d\n",&guess1);
    ...
    if (guess1 == computer1){
        ...
        if (new_los == 0){
            ...
            if (decision == 1){
                ...
                int bet3;
                printf("Enter amount to bet %s: ",name);
                scanf("%d",bet3);
                printf("\n\n");
                ...
                if (guess2 == computer2){
                    ...
                    printf("You hve $%d as total", b2);

                    printf("\n\n");

                    if (b2 ==0){
                        printf("%s, You have $0 as a balance\n");
                        printf("You have no more money to play!\n");
            ...
            {
                printf("Have a nice day sir %S",name);
            }
